...
\newcommand{\hintquestion}[2][question]{\paragraph{Hint
    for #1 \ref{#2}:~}}
...
\newcommand{\tip}{{\sffamily\bfseries{}Tip:}}
\newcommand{\note}{\par\raisebox{-2pt}{\includegraphics[height=12pt]{preamble/magnify}}}
...
\newcolorlabel{labelnode}{SlateBlue4}
\newcommand{\node}{\labelnode{node}}
...
\ifnotempty{#1}{\markerout{Marker argument [type] [#1]}type \var{#1}})}%
...
% Attributes
\newenvironment{attributespecification}{\markerout{Marker attribute [start]}\begin{mdframed}[style=functionspecification]}{\markerout{Marker attribute [end]}\end{mdframed}}
\newenvironment{adescription}{\fdescription}{\endfdescription}
\newcommand{\aname}[1]{\noindent{\titlestyle Attribute name}: \var{#1}\par}
